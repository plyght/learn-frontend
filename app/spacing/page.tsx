        ...
        <article>
          <section className="mb-12">
            ...
            <p className="mb-4 text-[var(--foreground)] leading-relaxed">
              Random spacing values create visual chaos. A spacing system gives your UI 
              rhythm, consistency, and makes decisions faster. Instead of guessing "is this 
              13px or 17px?", you pick from a scale.
            </p>
            <p className="mb-4 text-[var(--foreground)] leading-relaxed">
              Most modern design systems use an <strong>8px base unit</strong>. Everything 
              is a multiple of 4 or 8 pixels. This creates visual harmony and makes your 
              code predictable.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="bg-[var(--muted)] border border-[var(--border)] rounded-sm p-6 mb-6">
              <div className="mb-6">
                <label htmlFor="base-unit-slider" className="block text-sm font-mono font-semibold mb-2">
                  Base Unit: <span className="text-[var(--accent)]">{baseUnit}px</span>
                </label>
                <input
                  id="base-unit-slider"
                  type="range"
                  ...
                  onInput={(e) => setBaseUnit(parseInt((e.target as HTMLInputElement).value, 10))}
              ...
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="border-b border-[var(--border)]">
                    <th className="text-left p-3 font-mono font-semibold">Multiplier</th>
                    <th className="text-left p-3 font-mono font-semibold">Value</th>
                ...
                <tbody>
                  <tr className="border-b border-[var(--border)]">
                    ...
                    <td className="p-3 text-[var(--muted-foreground)]">Tight spacing, icons to text</td>
                  </tr>
                  <tr className="border-b border-[var(--border)]">
                    <td className="p-3 font-mono">1x</td>
                    <td className="p-3 font-mono">8px</td>
                    <td className="p-3 text-[var(--muted-foreground)]">Related items, small gaps</td>
                  </tr>
                  <tr className="border-b border-[var(--border)]">
                    <td className="p-3 font-mono">1.5x</td>
                    <td className="p-3 font-mono">12px</td>
                    <td className="p-3 text-[var(--muted-foreground)]">Form fields, normal spacing</td>
                  </tr>
                  <tr className="border-b border-[var(--border)]">
                    <td className="p-3 font-mono">2x</td>
                    <td className="p-3 font-mono">16px</td>
                    <td className="p-3 text-[var(--muted-foreground)]">Card padding, list items</td>
                  </tr>
                  <tr className="border-b border-[var(--border)]">
                    <td className="p-3 font-mono">3x</td>
                    <td className="p-3 font-mono">24px</td>
                    <td className="p-3 text-[var(--muted-foreground)]">Section spacing, headers</td>
                  </tr>
                  <tr className="border-b border-[var(--border)]">
                    <td className="p-3 font-mono">4x</td>
                    <td className="p-3 font-mono">32px</td>
                    <td className="p-3 text-[var(--muted-foreground)]">Major sections, containers</td>
                  </tr>
                  <tr className="border-b border-[var(--border)]">
                    <td className="p-3 font-mono">6x</td>
                    <td className="p-3 font-mono">48px</td>
                    <td className="p-3 text-[var(--muted-foreground)]">Page sections, hero spacing</td>
                  </tr>
                  <tr className="border-b border-[var(--border)]">
                    <td className="p-3 font-mono">8x</td>
                    <td className="p-3 font-mono">64px</td>
                    <td className="p-3 text-[var(--muted-foreground)]">Large sections, page margins</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="bg-[var(--muted)] border border-[var(--border)] rounded-sm p-4">
                  ...
                  <p className="text-xs text-[var(--muted-foreground)] mt-2">12px between elements</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-[var(--muted)] border border-[var(--border)] rounded-sm p-4">
                  ...
                  <p className="text-xs text-[var(--muted-foreground)] mt-2">24px between sections</p>
                </div>
              </div>
...
<div className="gap-3 p-4 mb-6">`}
              ...
              <div className="border border-red-500/50 rounded-sm p-4">
                ...
                <p className="text-sm text-[var(--foreground)] mb-2">
                  Using 12px in one place and 14px in another for the same purpose.
                </p>
                <p className="text-sm text-[var(--muted-foreground)]">
              ...
              <div className="border border-green-500/50 rounded-sm p-4">
                ...
                <p className="text-sm text-[var(--foreground)] mb-2">
                  All related elements use the same spacing value from your scale.
                </p>
                <p className="text-sm text-[var(--muted-foreground)]">
          ...
          <section className="mb-12">
            ...
            <ul className="list-none space-y-4 ml-0">
              <li className="flex items-start">
                ...
                <div>
                  <strong className="block mb-1">Use CSS variables or design tokens</strong>
                  <p className="text-sm text-[var(--muted-foreground)]">
                    Define your spacing scale as tokens: <code className="bg-[var(--muted)] px-1 py-0.5 rounded text-xs">--space-1: 4px</code>, 
                    <code className="bg-[var(--muted)] px-1 py-0.5 rounded text-xs"> --space-2: 8px</code>, etc.
                  </p>
                </div>
              </li>
              <li className="flex items-start">
                ...
                <div>
                  <strong className="block mb-1">Round to the nearest token</strong>
                  <p className="text-sm text-[var(--muted-foreground)]">
                    If you measure 18px, use 16px. If you measure 22px, use 24px. 
              ...
              <li className="flex items-start">
                ...
                <div>
                  <strong className="block mb-1">Use semantic names when helpful</strong>
                  <p className="text-sm text-[var(--muted-foreground)]">
                    <code className="bg-[var(--muted)] px-1 py-0.5 rounded text-xs">gap-tight</code>, 
                    <code className="bg-[var(--muted)] px-1 py-0.5 rounded text-xs"> gap-normal</code>, 
                    <code className="bg-[var(--muted)] px-1 py-0.5 rounded text-xs"> gap-section</code> 
              ...
              <li className="flex items-start">
                ...
                <div>
                  <strong className="block mb-1">Start with the scale, adjust if needed</strong>
                  <p className="text-sm text-[var(--muted-foreground)]">
                    Pick from your scale first. Only deviate if it genuinely looks wrong, 
                    and then round to the nearest token.
                  </p>
                </div>
              </li>
            </ul>
          ...
          <section className="mb-12">
            ...
            <div className="bg-[var(--muted)] border border-[var(--border)] rounded-sm p-6">
              <p className="text-sm font-mono font-semibold mb-4">Tailwind CSS spacing scale:</p>
              <div className="grid md:grid-cols-2 gap-4 text-xs font-mono">
                <div>
                  <div className="mb-2"><code className="bg-[var(--code-bg)] px-2 py-1 rounded">p-1</code> = 4px</div>
                  <div className="mb-2"><code className="bg-[var(--code-bg)] px-2 py-1 rounded">p-2</code> = 8px</div>
                  <div className="mb-2"><code className="bg-[var(--code-bg)] px-2 py-1 rounded">p-3</code> = 12px</div>
                  <div className="mb-2"><code className="bg-[var(--code-bg)] px-2 py-1 rounded">p-4</code> = 16px</div>
                  <div className="mb-2"><code className="bg-[var(--code-bg)] px-2 py-1 rounded">p-6</code> = 24px</div>
                </div>
                <div>
                  <div className="mb-2"><code className="bg-[var(--code-bg)] px-2 py-1 rounded">p-8</code> = 32px</div>
                  <div className="mb-2"><code className="bg-[var(--code-bg)] px-2 py-1 rounded">p-12</code> = 48px</div>
                  <div className="mb-2"><code className="bg-[var(--code-bg)] px-2 py-1 rounded">p-16</code> = 64px</div>
                  <div className="mb-2"><code className="bg-[var(--code-bg)] px-2 py-1 rounded">p-20</code> = 80px</div>
                  <div className="mb-2"><code className="bg-[var(--code-bg)] px-2 py-1 rounded">p-24</code> = 96px</div>
                </div>
              </div>
            </div>
          </section>
