...
export default function Day4Component() {
  ...
  const styles = {
    "--font-sans":
      'var(--font-familjen), -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"',
    "--font-display":
      'var(--font-familjen), -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"',
    "--spacing": "0.25rem",
    "--container-7xl": "80rem",
      ...
      <section className="w-full" style={{ backgroundColor: "#F1F3F2" }}>
        ...
        >
          ...
          >
            ...
            {/* CTA Buttons */}
            <div
              className="flex flex-col sm:flex-row items-center justify-start"
              style={{ gap: "calc(var(--spacing)*4)" }}
            >
              <a
                href="#"
              ...
              >
                ...
                <svg
                  ...
                  viewBox="0 0 13 7"
                  fill="none"
                  style={{ width: "0.8125rem", height: "0.4375rem" }}
                >
                  <path
